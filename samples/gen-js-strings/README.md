...
* [nil-test](#module_nil-test)
    * [NilTest](#exp_module_nil-test--NilTest) ⏏
        ...
        * _instance_
            ...
            * [.getDistricts(params, [options], [cb])](#module_nil-test--NilTest+getDistricts) ⇒ <code>Promise</code>
        * _static_
...
<a name="module_nil-test--NilTest+getDistricts"></a>

#### nilTest.getDistricts(params, [options], [cb]) ⇒ <code>Promise</code>
**Kind**: instance method of [<code>NilTest</code>](#exp_module_nil-test--NilTest)  
...
| [params.where] |  |  | JSON-serialized "where" filter to apply to the query. |
| [params.startingAfter] | <code>string</code> |  |  |
| [params.endingBefore] | <code>string</code> |  |  |
