...
// ContextValidate validates this thing with date range based on context it is used
func (m *ThingWithDateRange) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
