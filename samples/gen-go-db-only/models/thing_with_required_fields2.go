...
// ContextValidate validates this thing with required fields2 based on context it is used
func (m *ThingWithRequiredFields2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
