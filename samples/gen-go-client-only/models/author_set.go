...
// ContextValidate validate this author set based on the context it is used
func (m *AuthorSet) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AuthorSet) contextValidateResults(ctx context.Context, formats strfmt.Registry) error {
