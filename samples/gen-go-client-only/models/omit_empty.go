...
// ContextValidate validates this omit empty based on context it is used
func (m *OmitEmpty) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
