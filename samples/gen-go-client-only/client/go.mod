...
require (
	//removed this because it can never get the right version unless I tag it first. Adding with: go get github.com/Clever/wag/samples/gen-go-client-only/models@9.0.0
