...
module github.com/Clever/wag/samples/gen-go-client-only/client

go 1.16

require (
	github.com/Clever/wag/samples/v8/gen-go-client-only/models v0.0.0-00010101000000-000000000000
