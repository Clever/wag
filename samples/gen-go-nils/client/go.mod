...
module github.com/Clever/wag/samples/v8/gen-go-nils/client

go 1.16

require (
	github.com/Clever/wag/samples/v8/gen-go-nils/models v0.0.0
...
require (
	...
	replace github.com/Clever/wag/samples/v8/gen-go-nils/models => ../models
)
