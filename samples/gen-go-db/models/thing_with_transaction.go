...
type ThingWithTransaction struct {

	// name
	Name string `json:"name,omitempty"`
}

// Validate validates this thing with transaction
func (m *ThingWithTransaction) Validate(formats strfmt.Registry) error {
	return nil
}
