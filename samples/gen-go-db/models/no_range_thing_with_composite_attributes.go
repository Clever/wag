...
// ContextValidate validates this no range thing with composite attributes based on context it is used
func (m *NoRangeThingWithCompositeAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
