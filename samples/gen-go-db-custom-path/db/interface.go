...
type Interface interface {
	...
	GetArrayOfDeployment(ctx context.Context, ms []models.Deployment) ([]models.Deployment, error)
	...
	GetArrayOfEvent(ctx context.Context, ms []models.Event) ([]models.Event, error)
	...
	GetArrayOfNoRangeThingWithCompositeAttributes(ctx context.Context, ms []models.NoRangeThingWithCompositeAttributes) ([]models.NoRangeThingWithCompositeAttributes, error)
	...
	GetArrayOfSimpleThing(ctx context.Context, ms []models.SimpleThing) ([]models.SimpleThing, error)
	...
	GetArrayOfTeacherSharingRule(ctx context.Context, ms []models.TeacherSharingRule) ([]models.TeacherSharingRule, error)
	...
	GetArrayOfThing(ctx context.Context, ms []models.Thing) ([]models.Thing, error)
	...
	GetArrayOfThingAllowingBatchWrites(ctx context.Context, ms []models.ThingAllowingBatchWrites) ([]models.ThingAllowingBatchWrites, error)
	...
	GetArrayOfThingAllowingBatchWritesWithCompositeAttributes(ctx context.Context, ms []models.ThingAllowingBatchWritesWithCompositeAttributes) ([]models.ThingAllowingBatchWritesWithCompositeAttributes, error)
	...
	GetArrayOfThingWithAdditionalAttributes(ctx context.Context, ms []models.ThingWithAdditionalAttributes) ([]models.ThingWithAdditionalAttributes, error)
	...
	GetArrayOfThingWithCompositeAttributes(ctx context.Context, ms []models.ThingWithCompositeAttributes) ([]models.ThingWithCompositeAttributes, error)
	...
	GetArrayOfThingWithCompositeEnumAttributes(ctx context.Context, ms []models.ThingWithCompositeEnumAttributes) ([]models.ThingWithCompositeEnumAttributes, error)
	...
	GetArrayOfThingWithDateGSI(ctx context.Context, ms []models.ThingWithDateGSI) ([]models.ThingWithDateGSI, error)
	...
	GetArrayOfThingWithDateRange(ctx context.Context, ms []models.ThingWithDateRange) ([]models.ThingWithDateRange, error)
	...
	GetArrayOfThingWithDateRangeKey(ctx context.Context, ms []models.ThingWithDateRangeKey) ([]models.ThingWithDateRangeKey, error)
	...
	GetArrayOfThingWithDateTimeComposite(ctx context.Context, ms []models.ThingWithDateTimeComposite) ([]models.ThingWithDateTimeComposite, error)
	...
	GetArrayOfThingWithDatetimeGSI(ctx context.Context, ms []models.ThingWithDatetimeGSI) ([]models.ThingWithDatetimeGSI, error)
	...
	GetArrayOfThingWithEnumHashKey(ctx context.Context, ms []models.ThingWithEnumHashKey) ([]models.ThingWithEnumHashKey, error)
	...
	GetArrayOfThingWithMatchingKeys(ctx context.Context, ms []models.ThingWithMatchingKeys) ([]models.ThingWithMatchingKeys, error)
	...
	GetArrayOfThingWithMultiUseCompositeAttribute(ctx context.Context, ms []models.ThingWithMultiUseCompositeAttribute) ([]models.ThingWithMultiUseCompositeAttribute, error)
	...
	GetArrayOfThingWithRequiredCompositePropertiesAndKeysOnly(ctx context.Context, ms []models.ThingWithRequiredCompositePropertiesAndKeysOnly) ([]models.ThingWithRequiredCompositePropertiesAndKeysOnly, error)
	...
	GetArrayOfThingWithRequiredFields(ctx context.Context, ms []models.ThingWithRequiredFields) ([]models.ThingWithRequiredFields, error)
	...
	GetArrayOfThingWithRequiredFields2(ctx context.Context, ms []models.ThingWithRequiredFields2) ([]models.ThingWithRequiredFields2, error)
	...
	GetArrayOfThingWithTransactMultipleGSI(ctx context.Context, ms []models.ThingWithTransactMultipleGSI) ([]models.ThingWithTransactMultipleGSI, error)
	...
	GetArrayOfThingWithTransaction(ctx context.Context, ms []models.ThingWithTransaction) ([]models.ThingWithTransaction, error)
	...
	GetArrayOfThingWithTransactionWithSimpleThing(ctx context.Context, ms []models.ThingWithTransactionWithSimpleThing) ([]models.ThingWithTransactionWithSimpleThing, error)
	...
	GetArrayOfThingWithUnderscores(ctx context.Context, ms []models.ThingWithUnderscores) ([]models.ThingWithUnderscores, error)
}
