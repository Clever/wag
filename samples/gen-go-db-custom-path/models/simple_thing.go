...
// ContextValidate validates this simple thing based on context it is used
func (m *SimpleThing) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
