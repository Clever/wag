...
// ContextValidate validates this thing with composite attributes based on context it is used
func (m *ThingWithCompositeAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
