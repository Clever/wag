...
// ContextValidate validates this thing with required fields based on context it is used
func (m *ThingWithRequiredFields) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
