...
module github.com/Clever/wag/samples/gen-go/client/v9
...
require (
	...
	//github.com/Clever/wag/samples/gen-go/models/v9 v9.0.0
...
replace github.com/Clever/wag/samples/gen-go/models/v9 v9.0.0 => ../models 