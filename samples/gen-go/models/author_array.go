...
// ContextValidate validate this author array based on the context it is used
func (m AuthorArray) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
