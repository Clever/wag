...
module github.com/Clever/wag/samples/v8/gen-go-errors/client

go 1.16

require (
	github.com/Clever/wag/samples/v8/gen-go-errors/models v0.0.0
...
require (
	...
	replace github.com/Clever/wag/samples/v8/gen-go-errors/models => ../models
)
