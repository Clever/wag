...
func _hardcodedDoerGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "_hardcoded/doer.go", size: 10557, mode: os.FileMode(420), modTime: time.Unix(1493930058, 0)}
...
func _hardcodedMiddlewareGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "_hardcoded/middleware.go", size: 3827, mode: os.FileMode(420), modTime: time.Unix(1493930058, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
