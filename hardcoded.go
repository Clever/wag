...
func hardcoded_doerGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "hardcoded/_doer.go", size: 2319, mode: os.FileMode(436), modTime: time.Unix(1472166826, 0)}
...
func hardcoded_middlewareGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "hardcoded/_middleware.go", size: 1395, mode: os.FileMode(436), modTime: time.Unix(1472166850, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
