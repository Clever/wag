...
func hardcoded_middlewareGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "hardcoded/_middleware.go", size: 2702, mode: os.FileMode(420), modTime: time.Unix(1475028495, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
