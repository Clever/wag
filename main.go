...
func injectDefaultDefinitions(swaggerSpec *spec.Swagger) {
	...
	// TODO: this should be moved to rbac-scoping-utils to maintain as the source of truth
	// UserContext is defined in the swagger spec and will be generated by go-swagger
	swaggerSpec.Definitions["UserContext"] = spec.Schema{
		SchemaProps: spec.SchemaProps{
			Type: spec.StringOrArray{"object"},
			Properties: map[string]spec.Schema{
				"userID": {
