...
generate: build jsdoc2md
	...
	./bin/wag -file samples/app-service.yml -go-package $(PKG)/samples/gen-go-app-service -js-path $(GOPATH)/src/$(PKG)/samples/gen-js-app-service
	cd $(GOPATH)/src/$(PKG)/samples/gen-js-app-service && jsdoc2md index.js types.js > ./README.md
	go generate $(PKG)/samples/gen-go-app-service...
